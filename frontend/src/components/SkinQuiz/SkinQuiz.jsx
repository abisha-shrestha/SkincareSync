...
export default function SkinQuiz() {
  ...
  return (
    <>
      <nav className="navbar navbar-quiz" style={{ position: 'absolute', top: 0, width: '100%', zIndex: 1000 }}>
        {/* Your existing navbar code can go here if needed */}
      </nav>
      ...
      <div className="quiz-overlay">
        <div className="quiz-container">
          <div className="quiz-header">
            ...
            <p className="quiz-subtitle">Answer honestly for best results</p>
          </div>
          ...
          {currentIndex < questions.length ? (
            ...
            <div className="quiz-complete">
              ...
              <p style={{ fontSize: '18px', color: '#6b5d52', marginBottom: '2rem' }}>
                Your personalized skin profile will be generated shortly.
              </p>
              <button className="quiz-finish">
                View My Results
              </button>
            </div>
          )}
